<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="起点站" width="180" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column label="终点站" width="180" align="center">
        <template slot-scope="scope">
...
<script>
import { findStation, getStationName } from '@/api/station'
  ...
  methods: {
    ...
    Search() {
      if (this.searchForm.start_station !== null && this.searchForm.end_station !== null) {
        this.listLoading = true
        findStation(this.searchForm.start_station, this.searchForm.end_station).then(response => {
